...
export default function Footer(){
    return (
        <section className='bg-black text-white py-[40px] px-[24px] md:px-[80px] flex flex-col gap-[12px] border-t-2 border-t-[#5B5B5B] mt-7 w-screen ml-[-24px] md:ml-[-80px]'>
            ...
            <p className='text-sm md:max-w-[80%] lg:max-w-[50%] md:text-[1rem]'>Front-end developer. From Ikea furniture to full-stack web apps... I just love building stuff.</p>
            ...
            <p className='hidden md:block justify-self-end self-end'>@Belen Garcia Martinez 2024</p>
            </div>
        </section>
    )
}